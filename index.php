    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        input, textarea { 
            ...
            border: 1px solid var(--border); color: white; border-radius: 15px; 
        ...
        .btn-submit { 
            ...
            border-radius: 15px; font-weight: 800; cursor: pointer; transition: 0.4s; color: #000;
        }

        .social-link {
            background: var(--card-bg); border: 1px solid var(--border); 
            padding: 30px; border-radius: 30px; text-align: center; color: white; 
            text-decoration: none; display: flex; flex-direction: column; gap: 10px; transition: 0.4s;
        }
